...
class _DashboardPremiumState extends State<DashboardPremium> {
  ...
  Future<void> _grabarVoz() async {
    ...
    try {
      ...
      if (out != null && mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Audio: $out')));
            ...
            slivers: [
              ...
              SliverPadding(
                ...
                sliver: SliverList.list(children: [
                  // ARRIBA: Lobby + Sonando lado a lado
                  Row(children: [
                  ...
                  // PROTAGONISTA: Último Drop 320px
                  _heroCard(
                    tag: 'drop',
                    ...
                    child: lastDropUrl==null
                        ? const SizedBox(height: 320, child: Center(child: Text('Sin drops aún', style: TextStyle(color: Color(0xFF8A929A), fontSize: 12))))
                        : Container(
                            height: 320,
                    ...
                    children: [
                      _heroCard(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: 12),
                          InkWell(onTap: _grabarVoz, child: Container(width: 44,height: 44,decoration: const BoxDecoration(color: Color(0xFF1A1A1A), shape: BoxShape.circle), child: const Icon(Icons.mic_rounded, size: 18, color: Color(0xFFFFFFFF)))),
                          const SizedBox(height: 8),
